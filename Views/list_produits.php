            ...
            <div class="menu-sidebar__content js-scrollbar1">
                ...
                <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-tachometer-alt"></i>Boutique</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                <a href="ajout_produit.php">Ajouter Produit</a>
                                </li>
                                <li>
                                    <a href="shop-single.html">Articles</a>
                                </li>
                              
                            </ul>
                            <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-desktop"></i>Nutritions</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
...
<a href="downloads/masters.pdf" type="button">Download PDF file</a>
<?php
  ...
  <br> <input id="myInput" type="text" name="rechercher" placeholder="rechercher ..."> <br>
                      ...
                      <?    foreach ($listeProduit as $row) {?>
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td>
                                                    <form
                                  method="POST" action="supp_produit.php">
                        <input type="submit" name="supprimer" value="supprimer">
                        <input type="hidden" value=<?PHP echo $row['reference']; ?> name="reference">
                        <td>
                        <a href="modifier_produit.php?reference=<?PHP echo $row['reference']; ?>"> Modifier </a>
                    </td>
                               </form>
                                                    </td>
                                                    <tr class="spacer"></tr>
